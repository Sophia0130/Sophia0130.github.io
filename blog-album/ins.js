    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://github.com/Sophia0130/Sophia0130.github.io/tree/master/blog-album/mini_photos/' + data.link[i];
          var src = 'https://github.com/Sophia0130/Sophia0130.github.io/tree/master/blog-album/photos/' + data.link[i];
